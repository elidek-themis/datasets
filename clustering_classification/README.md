...
| Bank Marketing | 41K       | 20       | Gender, Marital status  | Predict if a client subscribes to a term deposit from Portuguese bank campaigns. | [Link](https://archive.ics.uci.edu/dataset/222/bank+marketing) |
...
| Diabetes (Hospital) | 70K       | 50+      | Race, Gender, Age       | Predict 30-day readmission from 10 years of US hospital diabetic patient records. | [Link](https://archive.ics.uci.edu/dataset/296/diabetes+130-us+hospitals+for+years+1999-2008) |
...
| ACSIncome      | 1.66M     | 15+      | Gender, Race            | Modern alternative to Adult dataset (2018). Predict income with flexible thresholds. | [Link]([https://www.openml.org](https://www.openml.org/search?type=data&sort=runs&id=43141&status=active)) |
